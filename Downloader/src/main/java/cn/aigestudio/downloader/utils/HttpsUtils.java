...
/**
 * 作者 create by moziqi on 2018/8/9
 * 邮箱 709847739@qq.com
 * 说明
 **/
public class HttpsUtils {

    public static HttpURLConnection https(URL serverUrl) throws IOException {
        HttpURLConnection conn = null;
        if ("https".equals(serverUrl.getProtocol().toLowerCase())) {
